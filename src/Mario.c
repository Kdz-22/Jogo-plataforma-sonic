...
Personagem *criarMario( float x, float y, float w, float h ) {
    ...
    m->animacoes[ESTADO_MARIO_PARADO] = &m->animacaoParado; quantidadeAnimacoes++;
    m->animacoes[ESTADO_MARIO_ANDANDO] = &m->animacaoAndando; quantidadeAnimacoes++;
    m->animacoes[ESTADO_MARIO_CORRENDO] = &m->animacaoCorrendo; quantidadeAnimacoes++;
    m->animacoes[ESTADO_MARIO_PULANDO] = &m->animacaoPulando; quantidadeAnimacoes++;
    m->animacoes[ESTADO_MARIO_PULANDO_CORRENDO] = &m->animacaoPulandoCorrendo; quantidadeAnimacoes++;
    m->animacoes[ESTADO_MARIO_CAINDO] = &m->animacaoCaindo; quantidadeAnimacoes++;
